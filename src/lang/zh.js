export default {
  route: {
    ...
    FinishedInformation: '产成品库存信息',
    InspectionData: '检验试验数据',
    ContactBox: '触头盒信息',
    CasingCabinet: '穿柜套管信息',
    StaticContact: '静触头信息',
    PostInsulator: '支柱绝缘子信息',
    CircuitTrolley: '断路器小车信息',
    CurrentTransformer: '电流互感器信息',
    VoltageTransformer: '电压互感器信息',
    LightningArrester: '避雷器信息',
    ChargedDisplay: '带电显示器信息',
    FuseInformation: '熔断器信息',
    BusInformation: '母排信息',
    CabinetMaterial: '柜体材质信息',
    ResistanceCircuit: '主回路电阻值',
    MechanicalOperation: '机械操作信息',
  ...
  permission: {
    ...
    discharge: '局放量(PC)',
    InspectionReportFile: '（电流互感器）检验报告附件',
    InspectionReportFileOther: '（电压互感器）检验报告附件',
    factoryCode: '厂区编号',
