<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.thickness')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.thickness }}
        </template>
      </el-table-column>
      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="130px" class="demo-ruleForm">
        <div class="bigUpBox">
          ...
          <div class="boxRight">
            ...
            <el-form-item label="材质"><el-input v-model="ruleForm.texture" :disabled="true" /></el-form-item>
          ...
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="厚度(μm):">
                <span>{{ props.row.requestBody.thickness }}</span>
              </el-form-item>
              <el-form-item label="（柜体材质、厚度）检验报告附件:">
...
import { cgczhdList, cgczhdDellte, cgczhdEdit, allLogs } from '@/api/business'
...
export default {
  ...
  data() {
    return {
      ...
      imgList: [], // 批量上传图片数组
      fileList: [],
      newDataImg: { id: '', imagePath: '', modelName: '柜体材质厚度' }, // 多个图片上传
      oneDataImg: { id: '', imagePath: '', modelName: '柜体材质厚度' }, // 单个图片上传或替换之前的图片
      editRow: {},
      editFileList: [],
  ...
  methods: {
    ...
    getList() {
      ...
      cgczhdList(this.pagination, this.listQuery).then(res => {
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          cgczhdEdit(this.ruleForm).then(res => {
            if (res.code === 200) {
              this.$message({
                type: 'success',
