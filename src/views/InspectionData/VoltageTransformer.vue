<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.rawMaterialSN')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.rawMaterialSN }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.ratedVoltage')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="$t('permission.dischargeA')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.dischargeA }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.dischargeB')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.dischargeB }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.dischargeC')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.dischargeC }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.inspectionReportFileDY')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
...
import { vtList, vtDellte, vtEdit, allLogs } from '@/api/business'
...
export default {
  ...
  data() {
    return {
      productionUrl: this.GLOBAL.BASE_URL + '/api/kvsc/vt/import/file',
      ...
      imgList: [], // 批量上传图片数组
      fileList: [],
      newDataImg: { id: '', imagePath: '', modelName: '电压互感器' }, // 多个图片上传
  ...
  methods: {
    ...
    getList() {
      ...
      vtList(this.pagination, this.listQuery).then(res => {
