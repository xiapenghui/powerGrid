<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.pdCode')" width="200">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="$t('permission.ratedCurrentOther')" width="200">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="$t('permission.loopResistanceA')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.loopResistanceA }}</span>
          <el-input v-else v-model="scope.row.loopResistanceA" />
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.loopResistanceB')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.loopResistanceB }}</span>
          <el-input v-else v-model="scope.row.loopResistanceB" />
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.loopResistanceC')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.loopResistanceC }}</span>
          <el-input v-else v-model="scope.row.loopResistanceC" />
        </template>
      </el-table-column>
...
import { mcrList, mcrDellte, mcrEdit, mcrOk } from '@/api/tenGrid'
