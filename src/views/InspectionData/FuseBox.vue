<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.continuousCurrent')" width="120">
        <template slot-scope="scope">
          {{ scope.row.continuousCurrent }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.inspectionReportFileRDQ')" width="150">
        <template slot-scope="scope">
