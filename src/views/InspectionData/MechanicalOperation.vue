<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.processTypeThree')" width="150">
        <template slot-scope="scope">
          ...
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="人力分合操作5次，可靠动作:">
                <span>{{ props.row.requestBody.openCloseFiveManual }}</span>
              </el-form-item>
              <el-form-item label="储能电机85%和110%操作电压，储能可靠动作:">
                <span>{{ props.row.requestBody.eightyFiveOper }}</span>
              </el-form-item>
              <el-form-item label="等于或低于30% 额定合闸电压时，操作5次，可靠不动作:">
                <span>{{ props.row.requestBody.thirtyRatedSwitch }}</span>
              </el-form-item>
              <el-form-item label="80%~110%额定合闸电压（交流）范围，操作5次，可靠合闸:">
                <span>{{ props.row.requestBody.eightyRatedSwitch }}</span>
              </el-form-item>
              <el-form-item label="65%~110%额定合闸电压（直流）范围，操作5次，可靠合闸:">
                <span>{{ props.row.requestBody.sixtyFiveRatedSwitch }}</span>
              </el-form-item>
              <el-form-item label="分闸电源低于额定30%，操作5次可靠不动作:">
                <span>{{ props.row.requestBody.lowerThirtyRated }}</span>
              </el-form-item>
              <el-form-item label="额定操作电压下，分合操作5次，均可靠动作:">
                <span>{{ props.row.requestBody.ratedVolAllReliable }}</span>
              </el-form-item>
              <el-form-item label="额定操作电压“分-0.3-合分”，可靠动作:">
                <span>{{ props.row.requestBody.ratedVolOpenClose }}</span>
              </el-form-item>
            </el-form>
          </template>
        </el-table-column>
