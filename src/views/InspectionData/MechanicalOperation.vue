<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.MaterialSNOther')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.MaterialSN }}</span>
          <el-input v-else v-model="scope.row.MaterialSN" />
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.eightyFiveOper')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.eightyFiveOper }}</span>
          <el-input v-else v-model="scope.row.eightyFiveOper" />
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.thirtyRatedSwitch')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.thirtyRatedSwitch }}</span>
          <el-input v-else v-model="scope.row.thirtyRatedSwitch" />
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.eightyRatedSwitch')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.eightyRatedSwitch }}</span>
          <el-input v-else v-model="scope.row.eightyRatedSwitch" />
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.sixtyFiveRatedSwitch')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.sixtyFiveRatedSwitch }}</span>
          <el-input v-else v-model="scope.row.sixtyFiveRatedSwitch" />
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.lowerThirtyRated')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.lowerThirtyRated }}</span>
          <el-input v-else v-model="scope.row.lowerThirtyRated" />
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.ratedVolAllReliable')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.ratedVolAllReliable }}</span>
          <el-input v-else v-model="scope.row.ratedVolAllReliable" />
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.ratedVolOpenClose')" width="200">
        <template slot-scope="scope">
          <span v-if="!scope.row.isEgdit">{{ scope.row.ratedVolOpenClose }}</span>
          <el-input v-else v-model="scope.row.ratedVolOpenClose" />
        </template>
      </el-table-column>
...
import { moList, moDellte, moEdit, moOk } from '@/api/tenGrid'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      moList(this.pagination, this.listQuery).then(res => {
