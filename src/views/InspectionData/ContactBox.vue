    ...
    <el-table :data="tabledatas" border @selection-change="handleSelectionChange">
      ...
      <el-table-column label="title">
        <template slot-scope="scope">
          <span v-if="scope.row.show"><el-input v-model="scope.row.title" size="mini" placeholder="请输入内容" /></span>
          <span v-else>{{ scope.row.title }}</span>
        </template>
      </el-table-column>
      <el-table-column label="text">
        <template slot-scope="scope">
          <span v-if="scope.row.show"><el-input v-model="scope.row.text" size="mini" placeholder="请输入内容" /></span>
