<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.rawMaterialBLQ')" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="$t('permission.voltageType')" width="120">
        <template slot-scope="scope">
          {{ scope.row.voltageType }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.refDCVoltageUn')" width="120">
        <template slot-scope="scope">
          {{ scope.row.refDCVoltageUn }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.refDCVoltage')" width="150">
        <template slot-scope="scope">
          {{ scope.row.refDCVoltage }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.leakageCurrentDC')" width="220">
        <template slot-scope="scope">
          {{ scope.row.leakageCurrentDC }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.inspectionReportFileBLQ')" width="180">
        <template slot-scope="scope">
