<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.pressureValueLD')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="130px" class="demo-ruleForm">
        <div class="bigUpBox">
          <div class="boxLeft">
            ...
            <el-form-item label="额定值(kV)"><el-input v-model="ruleForm.pressureValueUn" /></el-form-item>
          </div>
          <div class="boxRight">
            ...
            <el-form-item label="雷电冲击值(kV)"><el-input v-model="ruleForm.pressureValue" /></el-form-item>
          </div>
...
import { ldcjdysyList, ldcjdysyDellte, ldcjdysyEdit, allLogs } from '@/api/business'
...
export default {
  ...
  methods: {
      ...
      if (this.selectedData.length > 0) {
        this.$confirm(this.$t('table.deleteInfo'), this.$t('table.Tips') + this.$t('table.total') + this.selectedData.length + this.$t('table.dataInfo'), {
          ...
          .then(() => {
            ...
            ldcjdysyDellte(idList).then(res => {
              if (res.code === 200) {
                this.$message({
                  type: 'success',
                  message: res.message
    ...
    getList() {
      ...
      ldcjdysyList(this.pagination, this.listQuery).then(res => {
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ldcjdysyEdit(this.ruleForm).then(res => {
            if (res.code === 200) {
              this.$message({
                type: 'success',
