...
import { ctList, ctDellte, ctEdit, allLogs } from '@/api/business'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      ctList(this.pagination, this.listQuery).then(res => {
