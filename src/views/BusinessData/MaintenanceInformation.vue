<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="rolesList" style="width: 100%" border>
      ...
      <el-table-column align="center" :label="$t('permission.scheduleCode')" width="200">
        <template slot-scope="scope">
          {{ scope.row.scheduleCode }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.poItemIdId')" width="200">
        <template slot-scope="scope">
          {{ scope.row.poItemId }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.dataType')" width="200">
        <template slot-scope="scope">
          {{ scope.row.dataType }}
        </template>
      </el-table-column>
