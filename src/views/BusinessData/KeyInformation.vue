<template>
  <div class="app-container">
    <div class="search">
        ...
        <el-col :span="6">
          <el-col :span="8">
            <el-tooltip class="item" effect="dark" :content="content4" placement="top-start">
              <label class="radio-label">{{ $t('permission.matName') }}:</label>
            </el-tooltip>
          </el-col>
          <el-col :span="16"><el-input v-model="form.matName" :placeholder="$t('permission.matNameInfo')" clearable /></el-col>
        </el-col>
      ...
      <el-row :gutter="20" style="margin-top:20px">
        <el-col :span="6">
          ...
          <el-col :span="16"><el-input v-model="form.matCode" :placeholder="$t('permission.matCodeInfo')" clearable /></el-col>
        </el-col>

        <el-col :span="6">
          <el-col :span="8">
            <el-tooltip class="item" effect="dark" :content="content6" placement="top-start">
              <label class="radio-label">{{ $t('permission.matUnit') }}:</label>
            </el-tooltip>
          </el-col>
          <el-col :span="16"><el-input v-model="form.matUnit" :placeholder="$t('permission.matUnitInfo')" clearable /></el-col>
        </el-col>
    ...
    <el-table v-loading="listLoading" :data="rolesList" style="width: 100%" border>
      ...
      <el-table-column align="center" :label="$t('permission.matName')" width="150">
        <template slot-scope="scope">
          {{ scope.row.matName }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.matCode')" width="150">
        <template slot-scope="scope">
          {{ scope.row.matCode }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.matNum')" width="150">
        <template slot-scope="scope">
          {{ scope.row.matNum }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.matUnit')" width="200">
        <template slot-scope="scope">
          {{ scope.row.matUnit }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.matDescription')" width="200">
        <template slot-scope="scope">
          {{ scope.row.matDescription }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.matProdAddr')" width="200">
        <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      ...
      content4: this.$t('permission.matName'),
      content5: this.$t('permission.matCode'),
      content6: this.$t('permission.matUnit'),
      content7: this.$t('permission.ownerId'),
      content8: this.$t('permission.openId')
    }
  },
  computed: {},
  watch: {
    ...
    '$i18n.locale'() {
      ...
      this.content4 = this.$t('permission.matName')
      this.content5 = this.$t('permission.matCode')
      this.content6 = this.$t('permission.matUnit')
      this.content7 = this.$t('permission.ownerId')
      this.content8 = this.$t('permission.openId')
    }
  },
  created() {
