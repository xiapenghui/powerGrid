<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="rolesList" style="width: 100%" border>
      ...
      <el-table-column align="center" :label="$t('permission.provCoCode')" width="150">
        <template slot-scope="scope">
          {{ scope.row.provCoCode }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.provCoName')" width="150">
        <template slot-scope="scope">
          {{ scope.row.provCoName }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.planPeriod')" width="150">
        <template slot-scope="scope">
          {{ scope.row.planPeriod }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.actualPeriod')" width="150">
        <template slot-scope="scope">
          {{ scope.row.actualPeriod }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.schedule')" width="150">
        <template slot-scope="scope">
          {{ scope.row.schedule }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.dueDate')" width="150">
        <template slot-scope="scope">
          {{ scope.row.dueDate }}
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" :label="$t('permission.batchCode')" width="200">
        <template slot-scope="scope">
          {{ scope.row.batchCode }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.scheduleWo')" width="200">
        <template slot-scope="scope">
          {{ scope.row.scheduleWo }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.matCode')" width="200">
        <template slot-scope="scope">
          {{ scope.row.matCode }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.matDesc')" width="200">
        <template slot-scope="scope">
          {{ scope.row.matDesc }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.scheduleAmount')" width="200">
        <template slot-scope="scope">
          {{ scope.row.scheduleAmount }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.scheduleUnit')" width="200">
        <template slot-scope="scope">
          {{ scope.row.scheduleUnit }}
        </template>
      </el-table-column>
