<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="rolesList" style="width: 100%" border>
      ...
      <el-table-column align="center" :label="$t('permission.spareProductCode')" width="150">
        <template slot-scope="scope">
          {{ scope.row.spareProductCode }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.productDec')" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="$t('permission.dataSource')" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="$t('permission.remark')" width="150">
        <template slot-scope="scope">
          {{ scope.row.remark }}
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" :label="$t('permission.productLot')" width="200">
        <template slot-scope="scope">
