<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="rolesList" style="width: 100%" border>
      ...
      <el-table-column align="center" :label="$t('permission.insideNo')" width="150">
        <template slot-scope="scope">
          {{ scope.row.insideNo }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.deviceNo')" width="150">
        <template slot-scope="scope">
          {{ scope.row.deviceNo }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.productBatchNo')" width="150">
        <template slot-scope="scope">
          {{ scope.row.productBatchNo }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.processName')" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="$t('permission.processCode')" width="150">
        <template slot-scope="scope">
          {{ scope.row.processCode }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.processNo')" width="150">
        <template slot-scope="scope">
          {{ scope.row.processNo }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.workshopId')" width="200">
        <template slot-scope="scope">
          {{ scope.row.workshopId }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.workshopCode')" width="200">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="$t('permission.woNo')" width="200">
        <template slot-scope="scope">
          {{ scope.row.woNo }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.productId')" width="200">
        <template slot-scope="scope">
          {{ scope.row.productId }}
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" :label="$t('permission.orderStatus')" width="200">
        <template slot-scope="scope">
          {{ scope.row.orderStatus }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.buyerProvince')" width="200">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="$t('permission.wavyStatus')" width="200">
        <template slot-scope="scope">
